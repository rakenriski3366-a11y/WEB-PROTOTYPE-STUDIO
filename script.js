...
function initCursor() {
    ...
    document.querySelectorAll('a, button, .btn, .filter-btn, .time-slot, .preview-card, .package-card, .gallery-item, .theme-toggle').forEach(el => {
...
function initGSAP() {
    ...
    // Animasi yang sudah ada (hero image, preview cards, package cards) ...
    
    // Tambahan: parallax zoom pada hero background
